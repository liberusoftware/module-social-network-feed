...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-feed?sort=semver)](https://github.com/liberusoftware/module-social-network-feed/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-feed/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-feed/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-feed
```
...
<a href="https://github.com/liberusoftware/module-social-network-feed/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-feed" alt="Contributors to liberusoftware/module-social-network-feed">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-feed/graphs/contributors).
